...
while ($p = $result->fetch_assoc()) {
    ...
    echo "<a href='moderate.php?type=post&id={$p['id']}&action=approve'>Одобрить</a> | ";
    echo "<a href='moderate.php?type=post&id={$p['id']}&action=reject'>Отклонить</a><hr>";
}
...
while ($c = $result->fetch_assoc()) {
    ...
    echo "<a href='moderate.php?type=comment&id={$c['id']}&action=approve'>Одобрить</a> | ";
    echo "<a href='moderate.php?type=comment&id={$c['id']}&action=reject'>Отклонить</a><hr>";
}
